...
namespace RainMan.Tasks
{
    ...
    class CustomPolygon
    {
        ...
        public CustomPolygon(int size, List<PixelRep> pixels)
        {
            this.size = size;
            this.Pixels = pixels;
        }
    ...
    class PolygonPixels
    {
        ...
        public static List<PixelRep> getAllPointsInsidePolygon(CustomPolygon p)
        {
        ...
        public static Boolean isPointInsidePolygon(CustomPolygon p, int x, int y)
        {
